...
var (
	...
	lockChatsRepositoryMockGetMessageLast   sync.RWMutex
...
//             },
//             GetMessageLastFunc: func(ID uint64) (models.Message, error) {
// 	               panic("mock out the GetMessageLast method")
//             },
...
type ChatsRepositoryMock struct {
	...
	// GetMessageLastFunc mocks the GetMessageLast method.
	GetMessageLastFunc func(ID uint64) (models.Message, error)
	...
	calls struct {
		...
		// GetMessageLast holds details about calls to the GetMessageLast method.
		GetMessageLast []struct {
			// ID is the ID argument value.
			ID uint64
		}
...
// GetMessageLast calls GetMessageLastFunc.
func (mock *ChatsRepositoryMock) GetMessageLast(ID uint64) (models.Message, error) {
	if mock.GetMessageLastFunc == nil {
		panic("ChatsRepositoryMock.GetMessageLastFunc: method is nil but ChatsRepository.GetMessageLast was just called")
	}
	callInfo := struct {
		ID uint64
	}{
	...
	lockChatsRepositoryMockGetMessageLast.Lock()
	mock.calls.GetMessageLast = append(mock.calls.GetMessageLast, callInfo)
	lockChatsRepositoryMockGetMessageLast.Unlock()
	return mock.GetMessageLastFunc(ID)
}

// GetMessageLastCalls gets all the calls that were made to GetMessageLast.
// Check the length with:
//     len(mockedChatsRepository.GetMessageLastCalls())
func (mock *ChatsRepositoryMock) GetMessageLastCalls() []struct {
	ID uint64
} {
	var calls []struct {
		ID uint64
	}
	lockChatsRepositoryMockGetMessageLast.RLock()
	calls = mock.calls.GetMessageLast
	lockChatsRepositoryMockGetMessageLast.RUnlock()
	return calls
}
